...
public class InputManager : MonoBehaviour
{
    ...
    [Header("Player dodge input")]
    [Tooltip("Whether or not the dodge button was pressed this frame")]
    public bool dodgePressed;

    public void ReadDodgeInput(InputAction.CallbackContext context)
    {
        dodgePressed = !context.canceled;
        StartCoroutine(ResetDodgePressed());
    }

    IEnumerator ResetDodgePressed()
    {
        yield return new WaitForEndOfFrame();
        dodgePressed = false;
    }
